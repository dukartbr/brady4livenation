...
import { FaJs, FaReact, FaHtml5, FaPython, FaPhone, FaRegLightbulb } from "react-icons/fa6";
...
const passionItems: PanelItem[] = [
	{
		...
		description: `You'll never find someone more passionate about combining live music and software, than me. The world needs more live music, and Live Nation is the leader in that mission, it would be an honor to be able to help in such an endevour. As a musician and certified software addict, I will bring an unparalleled level of passion and care to the each line of code with a user focused mentality.`,
		icon: <FaRegLightbulb />
	},
	{
		id: 1,
